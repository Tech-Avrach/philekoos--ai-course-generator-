...
function CourseUrl({ COURSE_URL }) {
  ...
  return (
    <div>
      ...
      <div className={`border p-2 rounded-md flex justify-between items-center ${copied ? "border-primary" : " border-gray-400"}`}>
        <h2 className={`text-cente ${copied ? "text-primary" : " text-gray-400"}`}>{COURSE_URL}</h2>
